    ...
    return (
      <div ref="article" className="article">
        ...
        <div className="article-body">
          ...
          <p>At the end of the day, flowers and notes covered the monument that's been erected in Grigoropoulos's memory at <a onClick={this.handleClick.bind(this)} href="#image#3">the spot he was shot.</a></p>
